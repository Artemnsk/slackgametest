...
export function channelOverGameRoute(args: {channel: Channel}, router: InstallationRouter): void {
  inquirer.prompt([
    {
...
function _errorCallback(message: string, args: {channel: Channel}, router: InstallationRouter) {
  clearConsole();
  inquirer.prompt([
    {
      choices: [ ERROR_BACK ],
